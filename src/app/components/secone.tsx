...
const SecOne = () => {
  ...
  return (
    <div style={{
      ...
      <div className="bg-newred h-fit min-[1000px]:h-screen max-[999px]:pb-10 flex flex-col items-center gap-6 min-[1000px]:gap-15 justify-center">
          <div>
            <p className="text-3xl min-[1000px]:text-5xl text-newwhite pb-6 font-black">
          ...
          <div className="flex flex-col items-center gap-7 max-[999px]:hidden">
            ...
            <p className="block max-[999px]:hidden">*Навядзі на картку і убач</p>
          </div>
          <div className="flex flex-col items-center gap-7 min-[1000px]:hidden">
            <CardMobile title="Алеся Алейнікава" imageSrc="speakers/alesya_zaya_mobile.png" description="Гэта тэставае апісанне для карткі"/>
            <CardMobile title="Ульяна Якімчык" imageSrc="speakers/ulya_geniy_mobile.jpeg" description="Гэта тэставае апісанне для карткі"/>
