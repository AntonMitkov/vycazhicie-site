...
const SecThree = () => {
  ...
  return (
    <div style={{
        ...
        <div className="h-screen max-[700px]:h-fit bg-newwhite flex flex-col items-center justify-center gap-15 px-5 max-[700px]:py-15">
            ...
            <div>
                <div className="flex flex-row gap-5 max-[1200px]:flex-col">
                    ...
                    <div className="flex flex-row gap-5">
                      <Profile title="Таня Паклонская" imageSrc="orgs/vertik.png"/>
