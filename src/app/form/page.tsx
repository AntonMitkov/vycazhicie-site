        ...
        {!submitted ? (
          ...
          <div className="space-y-8">
            <p className="mt-6 text-newwhite font-medium text-lg leading-relaxed">
              ...
              Ваша тэма: «{topic}» зарэгістравана <br />
              Цяпер, калі ваша заяўка адпраўлена, мы б хацелі ацаніць вашы спікерскія навыкі. Для гэтага мы хочам, каб вы вывучылі наступны тэкст. Скрыньце яго, каб не страціць
          ...
          <div className="bg-[#1c1c1c] p-6 rounded-xl border border-gray-600 text-left text-base leading-relaxed">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                onClick={() => setLang(lang === "ru" ? "be" : "ru")}
                className="bg-gray-700 hover:bg-gray-600 transition px-3 py-1 rounded-md text-sm font-semibold"
              >
            ...
            {lang === "ru" ? (
              <p>
                ...
                <br /><br />
                Итак, кибернетическое бессмертие. Это концепция, которая предполагает,
                что можно достичь бессмертия, перенеся сознание человека в компьютер.
                Это, по сути, состояние, когда личность, воспоминания и сознание
                человека сохраняются и продолжают существовать вне физического тела.
                Оно может взаимодействовать с миром посредством виртуальных интерфейсов
                или даже роботизированных тел. Потребуется чрезвычайно мощный компьютер,
                способный поддерживать сложную симуляцию мозга в реальном времени.
                Это может быть квантовый компьютер, или другая принципиально новая
                технология. Кибернетика – не единственная область, которая позволяет
                человеку задуматься о подчинении времени. Иногда стремление обмануть жизнь
                выводит его за пределы своей Вселенной.»
              </p>
            ) : (
              <p>
                "Кібернетычная неўміручасць.
                <br /><br />
Такім чынам, кібернетычная неўміручасць. Гэта канцэпцыя, якая прадугледжвае, што можна дасягнуць неўміручасці, праз перанос свядомасці чалавека ў камп’ютар. Гэта, па сутнасці, стан, калі асоба, успаміны і свядомасць чалавека захоўваюцца і працягваюць існаваць па-за фізічным целам. Яно можа ўзаемадзейнічаць са светам з дапамогай віртуальных інтэрфейсаў або нават рабатызаваных цел. Спатрэбіцца надзвычай магутны камп’ютар, здольны падтрымліваць складаную сімуляцыю мозгу ў рэальным часе. Гэта можа быць квантавы камп’ютар, або іншая прынцыпова новая тэхналогія.
Кібернетыка - не адзіная вобласць, якая дазваляе чалавеку задумацца аб падначаленні часу. Часам імкненне падмануць жыццё выводзіць яго за межы сваёй сусвету.»
              </p>
            )}
          </div>
